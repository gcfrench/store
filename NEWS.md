...
-   Added **Git notes** for pulling and pushing own and others R projects to Git and GitHub and working on branches, written whilst reading the first 25 chapters of [Happy Git and GitHub for the useR](https://happygitwithr.com/).
