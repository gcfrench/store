...
-   Added **build quarto functions** to allow incorporation of html documents created in [quarto](https://quarto.org/) to be included in documentation generated by [pkgdown](https://pkgdown.r-lib.org/)
