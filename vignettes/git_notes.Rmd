...
-   Create and switch to a new branch: RStudio New Branch button
...
### [Clone others remote repository from GitHub](https://happygitwithr.com/common-remote-setups.html)

-   GitHub: Code - Copy HTTPS URL to clipboard.

**usethis::create_from_github** Clones and forks others remote repository from GitHub, creating a copy of the repository on Github, a local project and a Git repository.
