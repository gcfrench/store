...
**devtools::test_coverage()** - returns test coverage of R scripts or **devtools::test_coverage_active_file()**
highlights lines in single script 
```{r}
...
**attachment::att_amend_desc** looks through package scripts and adds missing package
dependencies to DESCRIPTION file
