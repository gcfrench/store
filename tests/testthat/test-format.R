...
test_that("comma delimited list returns unique string", {
  expect_equal(extract_comma_delimited_list(tibble::tibble(last_three_letters = c("x", "x")),
                                            column_name = "last_three_letters", unique_list = TRUE),
               "x")
})
